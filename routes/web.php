...
//Danh mục Bài viết
Route::middleware('check_login_admin')->group(function (){
    Route::group(['middleware'=>'admin:Admin,Quản lý marketing'],function () {
...
Route::middleware('check_login_admin')->group(function (){
    Route::group(['middleware'=>'admin:Admin,Quản lý bán hàng'],function () {
        ...
        Route::post('/delete-product-spec', [ProductController::class, 'delete_product_spec'])->name('delete-product-spec');
    });
});
//Comment về sản phẩm
Route::middleware('check_login_admin')->group(function (){
