...
@section('admin_content')
    {{ \DaveJamesMiller\Breadcrumbs\Facades\Breadcrumbs::render('view-thanh-toan-cong-no',$thanh_toan_cong_no) }}
    @if ($errors->any())
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input readonly class="form-control" id="noi_dung" type="text" name="noi_dung" value="{{$thanh_toan_cong_no->noi_dung}}" placeholder="Nhập nội dung">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input readonly class="form-control money" id="so_tien" type="text" name="so_tien" value="{{$thanh_toan_cong_no->so_tien}}" placeholder="Nhập số tiền">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
