                                                ...
                                                <tbody id="DynamicTable">
                                                    <tr>
                                                       ...
                                                       <td>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control gia_nhap" name="gia_nhap[]">
                                                        </td>
                                                        <td>
                                                            <input readonly type="number" class="form-control thanh_tien" name="thanh_tien[]">
                                                        </td>
                                                        <td>
...
<script>
    $(document).ready(function (){
        $("table").on("change", "input", function() {
            ...
            var price = parseFloat(row.find(".gia_nhap").val());
            var total = qty * price;
