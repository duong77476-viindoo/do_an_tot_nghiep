                    ...
                    <div class="payment-info">
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <strong>#{{$phieu_xuat->id}}</strong>
                            </div>
                            <div style="margin: 0px" class="col-xs-6 text-right">
                                <span>Ngày</span>
                                <strong>{{$phieu_xuat->updated_at}}</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="line-items">
                        <div class="headers clearfix">
                            <div class="row">
                                ...
                                <div class="col-xs-2">Số lượng thực xuất</div>
                                <div class="col-xs-2">Giá xuất</div>
                        ...
                        <div class="items">
                                @php
                                    $dem = 0;
                                @endphp
                            @foreach($chi_tiet_phieu_xuat as $key => $item)
                                <div class="row item">
                                    <div class="col-xs-1">
                                        {{$dem+=1}}
                                    </div>
                                    ...
                                    <div class="col-xs-2 amount">
                                        {{number_format($item->gia_xuat,0,',','.')}} VND
                                    </div>
                                    <div class="col-xs-2">
...
{{--                                    @endphp--}}
                    ...
                    <div style="border-bottom: 2px solid #EBECEE;" class="tong-tien row">
                        <div class="col-xs-6">
                            Thành tiền: <span style="font-weight: bold" class="">{{number_format($phieu_xuat->tong_tien,0,',','.')}} VND</span>
                            <br>
                            Chiết khấu: <span style="font-weight: bold">0 %</span>
                            <br>
                            VAT: <span style="font-weight: bold">0 VNĐ</span>
                            <br>
                            Tổng: <span style="font-weight: bold" class="text-primary">{{number_format($phieu_xuat->tong_tien,0,',','.')}} VND</span>
                        </div>
                        <div class="col-xs-5">
                            <p class="extra-notes">
