...
<script type="text/javascript">
    $(document).ready(function(){
        $(document).on('click','.add-to-cart-quickview',function(){
            ...
            var cart_product_qty = $('.cart_product_qty_' + id).val();//số lượng đặt
        ...
        $('.quick_view').click(function (){
           ...
           $.ajax({
              ...
              success:function (data){
                  ...
                  $('#product_quickview_cartQty').html(data.product_quickview_cartQty);
                  $('#go_to_product_detail').html(data.go_to_product_detail);
              }
           });
        });
...
{{--Script gallery ảnh sản phẩm chi tiết--}}
<script type="text/javascript">
    $(document).ready(function() {
...
{{--Script lấy thành phố , quận huyện, phường từ động--}}
<script type="text/javascript">
    $(document).ready(function (){
        $('.choose').on('change',function (){
            ...
            $.ajax({
                url: '{{url('/select-province-ward-frontend')}}',
                method: 'POST',
                data: {
                    action:action,
                    id:id,
...
{{--Script tính phí vận chuyênr--}}
<script type="text/javascript">
    $(document).ready(function (){
        $('.calculate_fee_ship').click(function (){
            var city = $('.city').val();
            var province = $('.province').val();
            var ward = $('.ward').val();
            var _token = $('input[name="_token"]').val();
            if(city == '' || province == '' || ward =='')
                alert('Làm điền đủ thông tin để tính phí vận chuyển');
            else{
                $.ajax({
                    url: '{{url('/calculate-fee-ship')}}',
                    method: 'POST',
                    data: {
                        city:city,
                        province:province,
    ...
    $(document).ready(function(){
        ...
        $('.confirm-order').click(function(){
            swal({
                    ...
                    text: "Vui lòng check kỹ lại thông tin đơn hàng!",
                    type: "warning",
                    showCancelButton: true,
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v13.0" nonce="mBBrcnFo"></script>
...
<script>
    ...
    chatbox.setAttribute("page_id", "101070305867083");
